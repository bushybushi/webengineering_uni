...
<head>
    ...
    <title>Manage Users - ΠΟΘΕΝ ΕΣΧΕΣ</title>
    <!-- Favicon -->
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <div class="border rounded p-2">
                                            <img src="../../uploads/id_photos/<?= htmlspecialchars($politician['front_photo_path']) ?>" 
                                                 class="img-fluid" 
                                                 alt="Front ID"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="border rounded p-2">
                                            <img src="../../uploads/id_photos/<?= htmlspecialchars($politician['back_photo_path']) ?>" 
                                                 class="img-fluid" 
                                                 alt="Back ID"
                                                 style="max-height: 200px; width: 100%; object-fit: contain;">
                                        </div>
