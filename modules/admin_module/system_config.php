...
<body>
    ...
    <main class="container mt-5 pt-5">
        ...
        <!-- Add Political Party Form -->
        <div class="card shadow-sm">
            <div class="card-body">
                <h2 class="card-title mb-4">Προσθήκη Πολιτικού Κόμματος</h2>
                <form method="POST">
                    <div class="mb-3">
                        <label for="party" class="form-label">Όνομα Κόμματος</label>
                        <input type="text" class="form-control" id="party" name="party" required>
                    </div>
                    <button type="submit" class="btn btn-primary" style="background-color: #ED9635; border-color: #ED9635;">
