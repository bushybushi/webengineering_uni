...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($pdo)) {
    try {
        ...
        $required_fields = [
            ...
            'party_id' => 'Πολιτικό Κόμμα/Παράταξη',
        ...
        if (empty($field_errors)) {
         ...
         // Insert declaration
            $stmt = $pdo->prepare("INSERT INTO declarations (user_id, title, submission_date, status, submission_period_id ) VALUES (?, ?, NOW(), 'Pending', ?)");
            $stmt->execute([$_SESSION['id'], $_POST['full_name'], $_POST['submission_period_id']]);
            ...
            // Insert other incomes
            if (isset($_POST['other_incomes'])) {
                $stmt = $pdo->prepare("INSERT INTO other_incomes (declaration_id, type, amount) 
                                      VALUES (:declaration_id, :type, :amount)");
                foreach ($_POST['other_incomes'] as $income) {
                    $amount = !empty($income['amount']) ? (float)$income['amount'] : null;
                    
                    $stmt->execute([
                        ':declaration_id' => $declaration_id,
                        ':type' => !empty($income['type']) ? $income['type'] : null,
                        ':amount' => $amount
                    ]);
                }
            }
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body p-5">
                                <form method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="row border rounded p-3 mb-3 g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="party_id" class="form-select <?php echo isset($field_errors['party_id']) ? 'is-invalid' : ''; ?>" required>
                                                ...
                                                <div class="invalid-feedback">
                                                    Παρακαλώ επιλέξτε Πολιτικό Κόμμα/Παράταξη
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <!-- Other Incomes -->
                                    <div class="mb-5">
                                        <h4 class="mb-4">9. Άλλα Εισοδήματα</h4>
                                        <div id="other-incomes-container">
                                            <div class="other-income-entry entry-container border rounded p-3 mb-3">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label">Τύπος Εισοδήματος</label>
                                                        <select name="other_incomes[0][type]" class="form-select">
                                                            <option value="">Επιλέξτε Τύπο</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="other_incomes[0][amount]" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-outline-warning" onclick="addOtherIncomeEntry()">
                                            <i class="bi bi-plus-circle"></i> Προσθήκη Άλλου Εισοδήματος
                                        </button>
                                    </div>

                                    <!-- Differences -->
                                    <div class="mb-5">
                                        <h4 class="mb-4">10. Διαφορές στα περιουσιακά στοιχεία</h4>
                                        <div class="row g-3">
                                            <div class="col-12">
                                    ...
                                    <!-- Previous Incomes -->
                                    <div class="mb-5">
                                        <h4 class="mb-4">11. Εισοδήματα προηγούμενων ετών (Σε σχέση με δηλώσεις προηγούμενων ετών)</h4>
                                        <div class="row g-3">
                                            <div class="col-12">
                                    ...
                                    <!-- Submission Period -->
                                    <div class="mb-5">
                                        <h4 class="mb-4">12. Περίοδος Υποβολής</h4>
